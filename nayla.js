...
{"urlButton": {"displayText": "SOURCE CODE","url": "17152248379"}},
{"urlButton": {"displayText": "OWNER","url": "https://wa.me/17152248379" + nomerowner}},
...
const reply = (teksnya) => {
const nyz1 = [{index: 1, urlButton: {displayText: 'OwnerBot', url: 'https://wa.me/17152248379' + nomerowner}}]
...
break
case 'invert': case 'uncover': case 'blur': 
case 'ad': case 'greyscale': case 'gun':
if (myLogin(sender) !== sender) return sendMedia("image","./media/image/login/home.jpg",`[ *YOU ARE UNKNOWN* ]\n\nAnda belum terdaftar di database bot, silahkan gunakan command\n( *BELUM PUNYA AKUN* )\n• ${prefix}signin pw-nya>\n*CONTOH* ?\n${prefix}signin ABC123\n( *SUDAH PUNYA AKUN* )\n• ${prefix}login nomer&pw-nya>\n*CONTOH* ?\n${prefix}login 62xxx&ABC123`)
if (isMedia || isQuotedImage) {
var stream = await downloadContentFromMessage(nay.message.imageMessage || nay.message.extendedTextMessage?.contextInfo.quotedMessage.imageMessage, 'image')
...
sendMedia("image", `https://myselfff.herokuapp.com/docs/canvas/${command}?url=${respon.result.namaFile}`,"SUKSES")
})
} else { reply("Kirim image/tag image")}
break
case 'facts': case 'pikachu':
case 'biden': case 'oogway': case 'sadcat':
if(!q) return reply("Masukkan text")
if (myLogin(sender) !== sender) return sendMedia("image","./media/image/login/home.jpg",`[ *YOU ARE UNKNOWN* ]\n\nAnda belum terdaftar di database bot, silahkan gunakan command\n( *BELUM PUNYA AKUN* )\n• ${prefix}signin pw-nya>\n*CONTOH* ?\n${prefix}signin ABC123\n( *SUDAH PUNYA AKUN* )\n• ${prefix}login nomer&pw-nya>\n*CONTOH* ?\n${prefix}login 62xxx&ABC123`)
sendMedia("image", `https://myselfff.herokuapp.com/docs/canvas/${command}?text=${q}`, "SUKSES")
break 
case 'alert':
if (myLogin(sender) !== sender) return sendMedia("image","./media/image/login/home.jpg",`[ *YOU ARE UNKNOWN* ]\n\nAnda belum terdaftar di database bot, silahkan gunakan command\n( *BELUM PUNYA AKUN* )\n• ${prefix}signin pw-nya>\n*CONTOH* ?\n${prefix}signin ABC123\n( *SUDAH PUNYA AKUN* )\n• ${prefix}login nomer&pw-nya>\n*CONTOH* ?\n${prefix}login 62xxx&ABC123`)
if(!q) return reply("Masukkan text")
sendMedia("image", `https://myselfff.herokuapp.com/docs/canvas/${command}?url=${q}`, "SUKSES")
break 
default: 
if (budy.includes("@")){
if (!isGroup) return
